...
# Constants and Paths
CSV_PATH = '/mnt/data/tc_track/ibtracs.since1980.list.v04r01.csv'
DIST_GRID_PATH = '/mnt/data/precipitation/dist2land_file/dist_to_land_mswep_10000.nc'
NC_FOLDER = '/mnt/data/precipitation/mswep'
INTERMEDIATE_SAVE_DIR = '/mnt/data/workplace/archive_mswep/intermediate_saves_10000_r500/'
PRE_SAVE_DIR = '/mnt/data/workplace/archive_mswep/heavy_precipitation_10000_r500/'
FINAL_SAVE_PATH = '/mnt/data/workplace/archive_mswep/intermediate_saves_10000_r500/updated_TC_data_final.csv'
SAVE_INTERVAL = 2000
...
def process_row(row):
    ...
    try:
        ...
        da = ds.precipitation[0].loc[59.95:-59.96] # adjusted as reality
