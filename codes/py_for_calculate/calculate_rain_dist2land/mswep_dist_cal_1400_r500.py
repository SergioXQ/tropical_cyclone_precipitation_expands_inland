...
DIST_GRID_PATH = '/mnt/data/precipitation/dist2land_file/dist_to_land_mswep_1400.nc'
NC_FOLDER = '/mnt/data/precipitation/mswep'
INTERMEDIATE_SAVE_DIR = '/mnt/data/workplace/archive_mswep/intermediate_saves_1400_r500/'
PRE_SAVE_DIR = '/mnt/data/workplace/archive_mswep/heavy_precipitation_1400_r500/'
FINAL_SAVE_PATH = '/mnt/data/workplace/archive_mswep/intermediate_saves_1400_r500/updated_TC_data_final.csv'
SAVE_INTERVAL = 2000
...
def process_row(row):
    ...
    try:
        ...
        da = ds.precipitation[0].loc[70.95:-71]/1000 # Convert m to km
